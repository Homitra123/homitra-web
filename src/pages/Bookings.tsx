...
import { Calendar, MapPin, Clock, User, CheckCircle, RefreshCw } from 'lucide-react';
      ...
      {(contentLoading || authLoading) ? (
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">
            {bookings.length === 0 ? 'No bookings yet' : `No ${activeTab} bookings`}
          </h3>
            ...
            >
              ...
              {booking.status === 'in_progress' && (
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mt-4">
                  <p className="text-orange-900 font-medium">Your service is currently in progress</p>
